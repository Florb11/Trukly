...
function GestionarReporteModal({ reporte, onClose, onActualizado }) {
  ...
  const cargarMecanicos = async () => {
    try {
      const resultado = await fetchConToken("https://trukly-production.up.railway.app/api/operador/mecanicos", { method: "GET" });
      if (!resultado) return;
  ...
  const guardarEstado = async () => {
    ...
    try {
      const resultado = await fetchConToken(
        `https://trukly-production.up.railway.app/api/reportes/${reporte.id_reporte}/estado`,
        {
          method: "PUT",
  ...
  const asignarMecanico = async () => {
    ...
    try {
      const resultado = await fetchConToken(
        `https://trukly-production.up.railway.app/api/reportes/${reporte.id_reporte}/asignar-mecanico`,
        {
          method: "PUT",
