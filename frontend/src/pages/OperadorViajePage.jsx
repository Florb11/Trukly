...
function OperadorViajesPage() {
  ...
  const cargarViajes = async () => {
    try {
      const resultado = await fetchConToken(
        "https://trukly-production.up.railway.app/api/operador/viajes",
        { method: "GET" },
      );
  ...
  const cargarChoferes = async () => {
    try {
      const resultado = await fetchConToken(
        "https://trukly-production.up.railway.app/api/operador/choferes",
        { method: "GET" },
      );
  ...
  const cargarCamiones = async () => {
    try {
      const resultado = await fetchConToken(
        "https://trukly-production.up.railway.app/api/operador/camiones",
        { method: "GET" },
      );
